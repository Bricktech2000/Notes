...
| $/a$                                                              | logical not                                      | `!a`                                    |
| $a\ /\ b$                                                         | logical difference                               | $a \land /b$                            |
| $a \equiv b$                                                      | logical equality                                 |                                         |
| $a \times b$                                                      | logical nonequality                              | equivalent to logical xor               |
| $a \vdash b$                                                      | implication, subset                              | _a implies b_                           |
| $a \dashv b$                                                      | reverse implication, superset                    | _a for all b_                           |
...
| $a^\omega$ where $\omega$ is a [[number]] and $V$ is a [[vector]] | the $\omega$ th element of $a$                   |                                         |
...
| $x_0 \mid x_1 \mid \dots x_n$ with $n = 3$ where $\mid$ is any operator | $x_0 \mid x_1 \mid x_2 \mid x_3$                      | step size is $1$ if $x_1 \mid$ is omitted |
