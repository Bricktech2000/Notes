...
- if $\int f\ x \mid \delta x\ \ \vdots\ \ \infty \cdot 0$ converges, then $b^0 : b^1 : \dots$ converges
- if $\int f\ x \mid \delta x\ \ \vdots\ \ \infty \cdot 0$ diverges, then $b^0 : b^1 : \dots$ diverges
...
_convergence_ a geometric [[series]] $b^0r0 : b^0r1 :\dots$ with $b^0 \ne 0$:
