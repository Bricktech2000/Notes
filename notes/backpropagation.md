...
to maximize $\Delta \mathcal L$, $\Delta a_y^y = (a_y^y \rarr \delta \mathcal L - \delta a_y^y)\ a_y^y$, see [[gradient]]

written differently, $\Delta a_y = (\delta a_y^y \rarr \delta \mathcal L - \delta a_y)\ a_y$
...
to maximize $\Delta L$, $\Delta w_{k \to j}^{j, k} = a_k^k \mid (z_j^j \rarr \delta\ g\ z_j^j - \delta z_j^j)\ z_j \mid \Delta a_j^j$, see [[gradient]]
...
to maximize $\Delta L$, $\Delta a_k^k = w_{k \to j}^{j, k} \mid (z_j^j \rarr \delta\ g\ z_j^j - \delta z_j^j)\ z_j \mid \Delta a_j^j$ summed over all $j$ , see [[gradient]]
